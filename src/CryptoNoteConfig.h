...
namespace CryptoNote {stockcoin
namespace parameters {STC
...
const char     CRYPTONOTE_NAME[ STOCKCOIN ]                           = "";
...
const int      P2P_DEFAULT_PORT                              = 889;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 890;
